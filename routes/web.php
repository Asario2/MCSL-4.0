...
use App\Http\Controllers\hackinglog;
...
use App\Http\Controllers\DumpgitdatabaseController;
...
// Route::middleware(['checksubd:ab,asario'])->group(function () {
    // Route::middleware('checksubd:ab,asario')->group(function () {
        ...
        Route::get("/api/gethelp/{slug}/{table}", [TablesController::class,"GetHelp"])->name("get.help");
...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/forgot-password', [CustomLoginController::class, 'sendRecoveryEmail'])->name('password.email');
    Route::get('/reset-password/{token}', [CustomLoginController::class, 'showResetForm'])->name('password.reset');
    Route::post('/reset-password', [CustomLoginController::class, 'pw_recovery'])->name('password.update');
});
...
### ============== API ISADMIN QI ================ ###
        ...
        Route::post('/contacts/import-preview', [CSVController::class, 'importContacts'])
        ...
        Route::put('/admin/contacts/{contact}/group', [TablesController::class, 'updateGroup'])
            ->name('admin.contacts.updateGroup');
...
Route::get('/tables/sort-enumis/{table}/{name}', [TablesController::class, 'getOptionz_itemscope'])
    ...
    // ❗ NICHT für echte Seiten löschen
