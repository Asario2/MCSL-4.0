...
//                 \Log::info($value2);
            ...
            $value = decval(decval_user($value,Auth::id()));
            $value = rumlaut($value);
...
public static function getOptions($name)
{
    ...
    */
    ...
    $orderColumn = Schema::hasColumn($table, 'position')
        ? 'position'
        : 'name';
    ...
    public static function getOptions_sel($table, $name)
    {
        ...
        {
            $statusvals = [
                ["id"=>"Einnahme","name"=>"Einnahmen"],
                ["id"=>"Ausgabe","name"=>"Ausgaben"],
...
// </div>";
    ...
    public static function Upload($name, $value = 0,$table,$create)
    {
