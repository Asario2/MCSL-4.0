...
5. import the `database/dumps/First_Commmit_ab_No_User.sql` & `Newer_Data_ab_*.sql` into your MySql/MariaDB database
...
15. Add "ab.test.mcs" subdomain in hosts file on IP 127.0.0.1
16. Surf to http://ab.test.mcs
17. log in with the values e-mail: `admin@example.com` and password: `TE6a9qpQ2pB47eqa8UjY`.
18. have fun
