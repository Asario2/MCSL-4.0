    ...
    <meta-header :title="headerTitle">
        ...
        <main id="app-layout-start">
            ...
            >
                ...
                <!-- Header -->
    <nav
        class="fixed top-0 left-0 right-0 z-30 bg-layout-sun-50 dark:bg-layout-night-00 ..."
    >
        <div class="w-full px-0 lg:mx-auto lg:max-w-6xl lg:px-6">

            <div class="flex w-full items-center justify-between py-4 lg:flex-col lg:justify-center lg:gap-4">

                <a href="/" class="block w-full ml-0">
                    <ClientOnly>
                        <pnalogo :mode="mode" />
                    </ClientOnly>
                </a>
                ...
                >
                    ...
                    <IconClose class="w-7 h-7" v-else />
                        ...
                        <div
                            ...
                            class="absolute inset-x-0 mt-[6] w-full px-6 py-4 shadow-md transition-all duration-300 ease-in-out bg-layout-sun-00 dark:bg-layout-night-00 lg:relative lg:top-0 lg:mt-0 lg:flex lg:w-auto lg:translate-x-0 lg:items-center lg:p-0 lg:opacity-100 lg:shadow-none lg:dark:bg-transparent"
                        >

                            <div
                                class="
                                    flex flex-col items-center space-y-1 SDAA
                                    lg:mt-4
                                    lg:flex-row
                                    lg:items-center
                                    lg:w-fit
                                ...
                                >
                                    ...
                                    <img
                                        ...
                                        :src="
                                            ...
                                            $page.props.auth.user?.profile_photo_url
                                                .replace('public','')
                                                .replace('http://localhost/images/','')
                                                .replace('images/images/','images/')
                                            ||
                                            '/images/profile-photos/008.jpg'
                                        "
                                ...
                                >
                                    ...
                                    <template #content>
                                        ...
                                        >
                                            ...
                                            <span
                                                v-if="
                                                    $page.props.userdata.application_count > 100
                                                "
                                            >
                                                Anwendung wechseln
                                            </span>
            ...
            <!--
            <div
                v-if="isLoading || loadingStore.isLoading"
                id="loader"
            ...
            <div
                class="container mx-auto max-w-6xl min-h-screen px-2 pm_top"
            >
                    ...
                    >
                        ...
                        <div class="md:grid md:grid-cols-2 md:gap-4">
                            ...
                            <div class="text-center md:text-left">
                                ...
                                <ul
                                    role="list"
                                    class="mt-6 space-y-4 list-none"
                                >

                                    <li>
                                        <link-footer
                                            name="Impressum"
                                            :route-name="route('home.imprint.pna')"
                                        />
                                    </li>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            headerDescription:
                this.$page?.props?.description ?? "",

            headerUrl:
                this.$page?.props?.url ?? null,

            headerImage:
                this.$page?.props?.image ?? null,
    ...
    mounted() {
        ...
        if (
            localStorage.getItem("mreload") === "true"
        ) {
